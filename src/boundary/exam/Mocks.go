...
// Source: src/boundary//exam/Boundary.go

// Package exam is a generated GoMock package.
package exam
...
func (m *MockIRepository) Insert(exam aggregates.Exam) (aggregates.Id, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Insert", exam)
...
func (mr *MockIRepositoryMockRecorder) Insert(exam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Insert", reflect.TypeOf((*MockIRepository)(nil).Insert), exam)
}

// GetByName mocks base method
func (m *MockIRepository) GetByName(name string) (aggregates.Exam, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByName", name)
	ret0, _ := ret[0].(aggregates.Exam)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetByName indicates an expected call of GetByName
func (mr *MockIRepositoryMockRecorder) GetByName(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByName", reflect.TypeOf((*MockIRepository)(nil).GetByName), name)
}
...
func (m *MockIByNameUseCase) ByName(name string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ByName", name)
}
...
func (m *MockIUploadUseCase) Upload(arg0 aggregates.Exam) {
	m.ctrl.T.Helper()
