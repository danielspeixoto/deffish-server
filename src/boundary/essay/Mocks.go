...
// Source: src/boundary//essay/Boundary.go
...
func (m *MockIUploadPresenter) OnUploaded(id aggregates.Id) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnUploaded", id)
}

// OnUploaded indicates an expected call of OnUploaded
func (mr *MockIUploadPresenterMockRecorder) OnUploaded(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnUploaded", reflect.TypeOf((*MockIUploadPresenter)(nil).OnUploaded), id)
}
...
// OnUploaded mocks base method
func (m *MockICommentPresenter) OnUploaded(id aggregates.Id) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnUploaded", id)
}

// OnUploaded indicates an expected call of OnUploaded
func (mr *MockICommentPresenterMockRecorder) OnUploaded(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnUploaded", reflect.TypeOf((*MockICommentPresenter)(nil).OnUploaded), id)
}
