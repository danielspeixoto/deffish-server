...
// Package mock_question is a generated GoMock package.
package question
...
func (m *MockIRepository) Random(amount int, tags []aggregates.Tag) ([]aggregates.Question, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIRepositoryMockRecorder) Random(amount, tags interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Random", reflect.TypeOf((*MockIRepository)(nil).Random), amount, tags)
}
...
func (m *MockIByIdPresenter) OnReceived(arg0 aggregates.Question) {
	m.ctrl.T.Helper()
...
// Random mocks base method
func (m *MockIRandomUseCase) Random(amount int, tags []aggregates.Tag) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Random", amount, tags)
}

// Random indicates an expected call of Random
func (mr *MockIRandomUseCaseMockRecorder) Random(amount, tags interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Random", reflect.TypeOf((*MockIRandomUseCase)(nil).Random), amount, tags)
}
...
func (m *MockIRandomPresenter) OnListReceived(arg0 []aggregates.Question) {
	m.ctrl.T.Helper()
...
func (m *MockIUploadUseCase) Upload(arg0 aggregates.Question) {
	m.ctrl.T.Helper()
